package br.com.dio.apiprevisaotempo.resources;
...
public class PrevisaoTempoResource {
	...
	public ResponseEntity<PrevisaoTempoResponseModel> get(final String city) {
		...
		log.info("PrevisaoTempoResource -> Consultando a previsão do tempo para cidade {}", city);
		
		if(city == null) {
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(null);
		}
		
		var retornoApi = service.fetchPrevisaoTempo(city);	
